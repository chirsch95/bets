...
# failures, expired keys, etc. Lowered from 5 to 2 on 2026-06-25 after
# downgrading Odds API back to the 500/mo plan: each pipeline run costs
# 8–16 credits, so 5 retries could burn the full day's budget on one
# staleness event.
RETRY_CAP = 2
